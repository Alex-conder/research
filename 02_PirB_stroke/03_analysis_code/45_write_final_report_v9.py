"""
生成最终阶段性报告 V9（完整版，加入空间转录组 Pirb+ spot 特征）
"""
import os
...
OUT_MD = "D:/Pirb_stroke_project/04_reports/脑缺血后Pirb阳性细胞单细胞图谱_机制深挖多数据集验证及多组学确认阶段性报告_V9.md"
OUT_DOCX = OUT_MD.replace(".md", ".docx")

report_md = """# 脑缺血后 Pirb 阳性细胞单细胞图谱：机制深挖、多数据集验证及多组学确认阶段性报告（V9）
