...
分析代码存放于 `../03_analysis_code/`，关键脚本包括：
- `../03_analysis_code/56_final_assembly_all.py`（一键重新生成最终交付物）
- `../03_analysis_code/55_gse225948_pb_de.py`（外周血 Mo/Neu 差异表达）
- `../03_analysis_code/54_nc_report_supp_graphical_abstract.py`（初始 NC 报告、补充表、Graphical Abstract）
- `../03_analysis_code/57_final_report_original_format.py`（原格式中文最终报告）
- `../03_analysis_code/58_generate_improvements_pdf.py`（提升点对比 PDF）
- `../03_analysis_code/59_package_deliverables.py`（打包脚本）
- `../03_analysis_code/60_nc_report_chinese.py`（本中文版报告生成脚本）
...
doc.add_paragraph('分析代码存放于 ../03_analysis_code/，关键脚本包括 56_final_assembly_all.py、55_gse225948_pb_de.py、54_nc_report_supp_graphical_abstract.py、57_final_report_original_format.py、58_generate_improvements_pdf.py、59_package_deliverables.py 和本中文版生成脚本 60_nc_report_chinese.py。')

doc.add_heading('利益冲突', level=1)
doc.add_paragraph('作者声明无利益冲突。')

doc.add_heading('补充信息', level=1)
doc.add_paragraph('补充表 1–8 存放于 ../04_reports/supplementary/Supplementary_Tables_Pirb_Stroke.xlsx；Graphical Abstract 存放于 ../04_reports/figures/graphical_abstract_draft.png/.svg/.pdf。')
